...
test('returns to login with a success message without signing in', async () => {
  ...
  expect(await screen.findByText('Pendaftaran berhasil! Silakan masuk menggunakan akunmu.')).toBeInTheDocument();
