...
export default function OrdersPage() {
  const { orders, deleteOrder, pending } = useOrders();
  ...
  async function confirmDelete() {
    ...
    } catch { setError('Pesanan belum berhasil dihapus. Periksa koneksi lalu coba lagi.'); }
  }
